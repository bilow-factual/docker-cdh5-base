FROM factual/docker-base-java:java7
...
ADD http://archive.cloudera.com/gplextras5/ubuntu/trusty/amd64/gplextras/cloudera.list /etc/apt/sources.list.d/gplextras.list
